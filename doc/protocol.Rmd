...
# bibliography: "C:\Users\au473419\Desktop\My EndNote Library-Converted Copy.bib"
editor_options: 
  markdown: 
    wrap: 72
---
...
transferable to the [Open Science Framework registry](https://osf.io/)
...
*Describe how the exposure was assessed (or refer to the UK Biobank link
on it)*

*Describe how the outcome was assessed (or refer to the UK Biobank link
on it)*

*Describe how the covariates were assessed (or refer to the UK Biobank
link on it)*

## Sample size

*Describe the participants. Describe the eligibility criteria and
sources of selection of participants. At this point it may not be
possible to know your sample size*
...
*Describe what data you will exclude and why. For instance, dropping
type 1 diabetes since you are only looking at type 2 diabetes. Or how
you will handle outliers.*
