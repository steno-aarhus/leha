...
geographical region of recruitment (ten UK regions), cohabitation (partner, children, sibling, parent, grandparent, grandchild, other related, other unrelated, no answer), anthropometry (BMI \[kg/m2\]), physical activity
(low \≤918 MET-min/week\], moderate \[918-3706 MET-min/week\], and high \[≥3706
MET-min/week\], unknown) [@Cassidy2016], smoking status (never, former, current 1-15
cigarettes per day, current ≥15 cigarettes per day, and smoking status unknown); metabolic
risk factors (self-reported \[yes, no, unknown\] diagnoses of
