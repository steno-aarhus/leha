---
title: "Protocol: Legume consumption and risk of gallbladder diseases in the UK Biobank Study: a prospective follow-up"
author:
  - name: Fie Langmann
...
## Legume consumption and risk of gallbladder diseases in the UK Biobank Study: a prospective follow-up
...
minimizes the risk of metabolic dysfunction-associated steatotic liver
disease (MASLD) in animals, by reducing build-up of fats in the liver
[@Hong2016; @Zhang2023; @Bouchenak2013; @Son2014; @Rigotti1989]. MASLD
is the most prevalent chronic liver disease in the Western countries
with a prevalence of 15-45 % [@Benedict2017; @Younossi2016]. The disease
...
mortality rate and lower risk of MASLD [@Song2016; @Zhang2023].
...
with data collected in a standardized format with the sole purpose of
...
(ICD-10) [@Digital2021]. MASLD was previously known as non-alcoholic
fatty liver disease (NAFLD), but the nomenclature was changed in 2023 to
...
early diagnoses of MASLD [@Thornton2023]. Due to this change in
nomenclature, incident cases of MASLD are diagnosed based on ICD-10-code
for NAFLD, K76.0, at first admission to hospital, while incident cases
of MASH are diagnosed based on ICD-10-code for NASH, K75.8
[@Biobank2020; @Zhang2023a].
...
(partner, children, sibling, parent, grandparent, grandchild, other
related, other unrelated, no answer), anthropometry (BMI \[kg/m2\]),
physical activity (low ≤918 MET-min/week\], moderate \[918-3706
MET-min/week\], and high \[≥3706 MET-min/week\], unknown)
[@Cassidy2016], smoking status (never, former, current 1-15 cigarettes
per day, current ≥15 cigarettes per day, and smoking status unknown);
metabolic risk factors (self-reported \[yes, no, unknown\] diagnoses of
