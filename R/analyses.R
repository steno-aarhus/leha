...
# Excluding alcohol intake above threshold from n events

# running model 2 with altered outcome definition
# i.e. cases with alcohol intake > 20 g/day for women and >30 g/day for men
